/* eslint-disable */
// Generated by Wrangler by running `wrangler types` (hash: 3e9ba7bcd8cc0632a7a8fa36da469cf8)
...
interface __BaseEnv_Env {
	...
	APP_EVENTS: Queue;
	AI: Ai;
	PANCAKE_ENVIRONMENT: "test";
	PANCAKE_CURRENCY: "USD";
	APP_COORDINATOR: DurableObjectNamespace<import("./src/worker").AppCoordinator>;
}
declare namespace Cloudflare {
	interface GlobalProps {
		mainModule: typeof import("./src/worker");
		durableNamespaces: "AppCoordinator";
	}
...
declare namespace NodeJS {
	interface ProcessEnv extends StringifyValues<Pick<Cloudflare.Env, "PANCAKE_ENVIRONMENT" | "PANCAKE_CURRENCY">> {}
}
