...
export const seoConfig: SeoInfrastructureConfig = {
  ...
  pages: [
    ...
    },
    {
      ...
      path: '/blog',
      locale: 'en',
      title: { messageKey: 'blog_meta_title' },
      description: { messageKey: 'blog_meta_description' },
      kind: 'pillar',
      alternateId: 'blog',
      primaryKeyword: { messageKey: 'blog_title' },
      breadcrumbIds: ['home-en'],
      imageAlt: { messageKey: 'social_image_alt' },
      indexable: true,
      changeFrequency: 'weekly',
      priority: 0.8,
